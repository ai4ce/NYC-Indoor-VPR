...
def parse_arguments():
    ...
    parser.add_argument("--cache_refresh_rate", type=int, default=100,
    ...
    parser.add_argument('--resize', type=int, default=[384, 384], nargs=2, help="Resizing shape for images (HxW).")
